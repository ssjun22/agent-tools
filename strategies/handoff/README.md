...
```bash
# 1. rules 복사
cp strategies/handoff/rules/handoff.md .claude/rules/

# 2. agents 복사
cp strategies/handoff/agents/handoff-creator.md .claude/agents/

# 또는 apply_to_repo 스크립트 사용
python3 agent-tools/.claude/skills/agent-strategy-manager/scripts/apply_to_repo.py handoff --repo <alias>
```
...
- **v1.0.0** - Initial strategy creation (2026-03-02)
