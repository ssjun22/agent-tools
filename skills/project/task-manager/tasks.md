...
### [#3] 키위티 점수 매핑 및 3-way 비교 분석 환경 구축
- **담당자**: JIRA_ASSIGNEE_D
- **보고자**: JIRA_ASSIGNEE_D
- **우선순위**: 중간
- **작업 기한**: 없음
...
- **연관 업무**: #1, #5
- **설명**:
  - **목표**: 키위티 점수 매핑 함수 개발 및 3-way 비교 분석 환경 구축
  - **배경**: 키위티 환경 분석 및 에이전트 결과 간 정렬을 통한 성능 검증 필요
  - **상세 내용**:
    - [x] 키위티 화면 분석하여 점수 체계 추론
  ...
  - **관련 파일**:
    ...
    - `llm-server/temp_score_test/scripts/mapping_functions.py`
